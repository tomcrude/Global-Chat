...
export default function Register() {
    ...
    return (
    <div className="container text-center mt-5 register position-absolute t-t">
    ...
    <form>
        <input placeholder="Max 10 characters" className="col-12 mt-3 input text-center mb-3" required onChange={(e)=>{setname(e.target.value)}} type="text" />
    ...
    <footer className="col-12 text-center mt-5" >
          <p className="text-muted text-decoration-underline">Angelo Smorlesi</p>
    </footer>
